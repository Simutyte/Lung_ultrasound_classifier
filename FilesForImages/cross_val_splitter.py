...
ap.add_argument(
    ...
    "--output_dir",
    type=str,
    default="/content/cross_validation/",
...
ap.add_argument(
    ...
    "--video_dir",
    type=str,
    default="/content/data/pocus_videos/convex/",
...
def check_crossval(cross_val_directory="/content/cross_validation"):
    """
