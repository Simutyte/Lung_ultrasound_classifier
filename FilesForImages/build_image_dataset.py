...
TAKE_MODE = ["convex", "linear"]  # can add linear
...
if __name__ == "__main__":
    ...
    parser.add_argument('-imgs', type=str, default="/content/data/pocus_images")
    parser.add_argument('-out', type=str, default="/content/image_dataset")
    parser.add_argument('-vids', type=str, default="/content/data/pocus_videos")
    parser.add_argument(
        '-fr',
